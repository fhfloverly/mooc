            ...
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="{{ asset('adminss/dist/img/user3-128x128.jpg') }}" class="img-circle" alt="User Image">
                          </div>
                          <h4>
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">暮雪依旧</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span></span> 用户管理<i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li class="active"><a href="{{ URL('admin/student') }}"><i class="fa fa-circle-o"></i> 学生管理</a></li>
                <li><a href="{{ URL('admin/teacher') }}"><i class="fa fa-circle-o"></i> 
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i> 类别信息</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> 查看所有文档</li>
                <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> 用户文档列表</a></li>
            ...
            <li class="treeview">
              <a href="#">
                <i class="fa fa-edit"></i> <span>评价管理</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="{{ URL('admin/') }}"><i class="fa fa-circle-o"></i> 评价删除</a></li>
                <li><a href="{{ URL('admin/talk') }}"><i class="fa fa-circle-o"></i> 用户禁言</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ URL('admin/tell') }}"><i class="fa fa-circle-o"></i> 查看公告</a></li>
                <li><a href="{{ URL('admin/atell') }}"><i class="fa fa-circle-o"></i>添加公告</a></li>
              </ul>
            </li>
            <li>
