    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{ asset('admin/index') }}" class="logo">
          ...
          <span class="logo-lg"><b>mooc</b></span>
        </a>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ URL('admin/wtext') }}"><i class="fa fa-circle-o"></i> 查看所有文档</li>
                <li><a href="{{ URL('admin/text') }}"><i class="fa fa-circle-o"></i> 用户文档列表</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/UI/general.html"><i class="fa fa-circle-o"></i> 查看所有视频</a></li>
                <li><a href="pages/UI/icons.html"><i class="fa fa-circle-o"></i> 用户视频列表</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/forms/general.html"><i class="fa fa-circle-o"></i> 评价删除</a></li>
                <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i> 用户禁言</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/tables/simple.html"><i class="fa fa-circle-o"></i> 查看公告</a></li>
                <li><a href="pages/tables/data.html"><i class="fa fa-circle-o"></i>添加公告</a></li>
              </ul>
            </li>
            <li>
